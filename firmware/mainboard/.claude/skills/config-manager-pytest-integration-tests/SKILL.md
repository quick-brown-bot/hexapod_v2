...
Generic integration-test rules such as determinism, fixture reuse, cleanup, and parameterization are already covered by `.claude/rules/mainboard/integration-testing-principles.md`. This skill only adds the robot-specific workflow and structure needed for live namespace testing.
